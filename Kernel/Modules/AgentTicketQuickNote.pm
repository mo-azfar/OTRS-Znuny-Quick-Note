...
sub Run {
    ...
    my $ArticleVisibility
        = $ConfigObject->Get('Ticket::Frontend::AgentTicketZoom')->{'Widgets'}->{'0099-TicketQuickNote'}
    ...
    {
        my $State = $ConfigObject->Get('Ticket::Frontend::AgentTicketZoom')->{'Widgets'}->{'0099-TicketQuickNote'}
            ->{'QuickCloseState'};
